<template>
<van-cell center :title="'VIP Level: ' + (userInfo.eUserLevel ? vipLevel[userInfo.eUserLevel]['level'] : vipLevel['0']['level'])">
    <template #icon>
...
<result-popup :show='showPicker' title='Congratulations' icon-class='dropdown-green' intro='You have successfully upgraded your account. Now you can power up your earnings.' target-url='account' target-name='My Account' :button-visible='true' @closeSuccessPopup='showPicker = false'></result-popup>
</template>
...
>>> > e136782e212e362e5a6ef1c7d5f9d362a7461032
});
</script>
